...
import {View, SafeAreaView, Text, TouchableOpacity, Image, ScrollView, Linking} from 'react-native';
import {
    ChatScreen_Title,
    ...
    return(
        <>
            ...
            <ScrollView>
                ...
                <TouchableOpacity style={{marginHorizontal: '20%', borderColor: colors.borderColor, borderWidth: 5, borderRadius: 20/2, marginBottom: 30}} onPressOut={() => {Linking.openURL('https://github.com/SquareTable/SocialSquare-Desktop')}}>
