...
import { StyleSheet, Text, View, Button, Image, TouchableOpacity, SafeAreaView, ScrollView, FlatList, Alert, useWindowDimensions, Animated, ActivityIndicator, Switch, Platform} from 'react-native';
                    ...
                    <View style={{flex: 2, flexDirection: 'row'}}>
                        ...
                        <View style={{flex: 1, flexDirection: 'column', alignItems: 'center'}}>
                            <Switch
                                ...
                                thumbColor={showPhotos ? colors.teritary : colors.primary}
                                ios_backgroundColor={colors.teritary}
                                onValueChange={() => {setContextAndAsyncStorage('ShowPhotos')}}
                                value={showPhotos}
                            />
                            <Switch
                                trackColor={{ false: colors.borderColor, true: colors.darkestBlue }}
                                thumbColor={showVideos ? colors.teritary : colors.primary}
                                ios_backgroundColor={colors.teritary}
                                onValueChange={() => {setContextAndAsyncStorage('ShowVideos')}}
                                value={showVideos}
                            />
                            <Switch
                                trackColor={{ false: colors.borderColor, true: colors.darkestBlue }}
                                thumbColor={showAudio ? colors.teritary : colors.primary}
                                ios_backgroundColor={colors.teritary}
                                onValueChange={() => {setContextAndAsyncStorage('ShowAudio')}}
                                value={showAudio}
                            />
                            <Switch
                                trackColor={{ false: colors.borderColor, true: colors.darkestBlue }}
                                thumbColor={showThreads ? colors.teritary : colors.primary}
                                ios_backgroundColor={colors.teritary}
                                onValueChange={() => {setContextAndAsyncStorage('ShowThreads')}}
                                value={showThreads}
                            />
                            <Switch
                                trackColor={{ false: colors.borderColor, true: colors.darkestBlue }}
                                thumbColor={showPolls ? colors.teritary : colors.primary}
                                ios_backgroundColor={colors.teritary}
                                onValueChange={() => {setContextAndAsyncStorage('ShowPolls')}}
                                value={showPolls}
                            />
                            <Switch
                                trackColor={{ false: colors.borderColor, true: colors.darkestBlue }}
                                thumbColor={showCategories ? colors.teritary : colors.primary}
                                ios_backgroundColor={colors.teritary}
                                onValueChange={() => {setContextAndAsyncStorage('ShowCategories')}}
