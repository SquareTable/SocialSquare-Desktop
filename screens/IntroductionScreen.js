...
import {View, Text, SafeAreaView, TouchableOpacity, ScrollView, StatusBar, Image, Dimensions, StyleSheet, Linking} from 'react-native';
...
const IntroScreen = () => {
    ...
    const goToLink = (linkToGoTo) => {
        Linking.openURL(linkToGoTo)
    };
    ...
    return(
        <AppIntroSlider 
            ...
            data={slides} 
            onDone={() => {setHasOpenedSocialSquare(true)}}
