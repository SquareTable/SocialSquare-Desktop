...
const EditCustomStyle = ({navigation, route}) => {
    const {name, indexNum, type, dark, stylingType, stylingVersion, primary, tertiary, borderColor, background, secondary, darkLight, brand, green, red, darkest, greyish, bronzeRarity, darkestBlue, navFocusedColor, navNonFocusedColor, orange, yellow, purple, slightlyLighterGrey, midWhite, slightlyLighterPrimary, descTextColor, errorColor, backToProfileScreen} = route.params;
    ...
    const leaveAndSave = async () => {
        ...
        currentSimpleStyleData.push({name: name, indexNum: indexNum, stylingType: stylingType, stylingVersion: stylingVersion, dark: dark, colors: {primary: primary, tertiary: tertiary, borderColor: borderColor, background: primary, secondary: secondary, darkLight: darkLight, brand: brand, green: green, red: red, darkest: darkest, greyish: greyish, bronzeRarity: bronzeRarity, darkestBlue: darkestBlue, navNonFocusedColor: navNonFocusedColor, navFocusedColor: navFocusedColor, orange: orange, yellow: yellow, purple: purple, slightlyLighterGrey: slightlyLighterGrey, midWhite: midWhite, slightlyLighterPrimary: slightlyLighterPrimary, descTextColor: descTextColor, errorColor: errorColor}})
        console.log(currentSimpleStyleData)
        AsyncStorage.setItem('simpleStylingData', JSON.stringify(currentSimpleStyleData))
        navigation.navigate('CustomStylesMenu', {ableToRefresh: true, indexNumToUse: indexNum, backToProfileScreen: goBackToProfileScreen});
    }
                ...
                {InfoPageIsHidden == true ?
                    <ScrollView style={{height: '100%'}} contentContainerStyle={{alignItems: 'center', backgroundColor: primary}}>
                        ...
                        <TouchableOpacity style={{justifyContent: 'center', borderColor: borderColor, borderWidth: 3, marginVertical: 10, borderRadius: 50, padding: 20, width: '90%'}} onPress={() => {
                            ...
                            navigation.navigate('ColorPickerScreen', {name: name, indexNum: indexNum, type: 'primary', dark: dark, stylingType: stylingType, stylingVersion: stylingVersion, primary: primary, tertiary: tertiary, borderColor: borderColor, secondary: secondary, background: background, darkLight: darkLight, brand: brand, green: green, red: red, darkest: darkest, greyish: greyish, bronzeRarity: bronzeRarity, darkestBlue: darkestBlue, navFocusedColor: navFocusedColor, navNonFocusedColor: navNonFocusedColor, orange: orange, yellow: yellow, purple: purple, slightlyLighterGrey: slightlyLighterGrey, midWhite: midWhite, slightlyLighterPrimary: slightlyLighterPrimary, descTextColor: descTextColor, errorColor: errorColor, placeToNavigateBackTo: 'EditCustomStyle'});
                        }}>
...
export default EditCustomStyle;